    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Tbl Leader Camp Add</h3>
            </div>
            <?php echo form_open('tbl_leader_camp/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="location_leader_camp" value="<?php echo $this->input->post('location_leader_camp'); ?>" class="form-control" id="location_leader_camp" />
